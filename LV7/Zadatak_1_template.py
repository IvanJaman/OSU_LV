...
# a) dio
print("Prema dijagramu raspršenja, postoje tri grupe podataka.")
...
print("Optimalna vrijednost k je 3 za prvi način generiranja podataka.")

# c) dio
print("Algoritam dobro radi kada su klasteri u obliku nakupina (blobs) koje mogu biti okrugle ili izduženije. Prestaje dobro raditi kada se podatci pojavljuju u oblicima kao što su kružnice ili polumjeseci.")
